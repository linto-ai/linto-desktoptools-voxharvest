...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ui.record_PB.clicked.connect(self._open_record_panel)
    ...
    def _open_record_panel(self):
        ...
        self.switch_panel(self._record_panel)
    ...
    def _open_resume_panel(self):
        if self._resume_panel is None:
            ...
            self._resume_panel.switch_to_text.connect(self._open_texts_panel)
            self._resume_panel.switch_to_record.connect(self._open_record_panel)
    ...
    def _set_button_enabled(self, visible):
    ...
    def switch_panel(self, panel_to_display):
        for panel, button in zip([self._home_panel, self._resume_panel, self._texts_panel, self._record_panel, self._audio_panel],
                                 [self.ui.home_PB, self.ui.home_PB, self.ui.text_PB, self.ui.record_PB, self.ui.setting_PB]):
